...
import { TUIComponent, Theme, Position, CodeViewerOptions } from './types';
import { Logger } from '../../core/logger';
import { ConfigManager } from '../../config/config-manager';
import { highlightCode, detectLanguage } from '../utils/syntaxHighlighter';

export class ContentPanel extends EventEmitter implements TUIComponent {
    private container!: blessed.Widgets.BoxElement;
    private tabBar!: blessed.Widgets.BoxElement;
    private codeViewer!: blessed.Widgets.TextareaElement;
    private statusLine!: blessed.Widgets.BoxElement;
    private config: ConfigManager;
    private logger: Logger;
    private openFiles: Map<string, any> = new Map();
    ...
    private createComponents(parent: blessed.Widgets.Node): void {
        ...
        // Code viewer/editor
        this.codeViewer = blessed.textarea({
            parent: this.container,
            top: 3,
            left: 0,
            width: '100%',
    ...
    private setupEventHandlers(): void {
        ...
        this.codeViewer.on('keypress', (ch: string, key: any) => {
            if (key.name === 'escape') {
                this.blur();
     ...
     * Apply syntax highlighting
     */
    private applySyntaxHighlighting(content: string, language: string): void {
        try {
