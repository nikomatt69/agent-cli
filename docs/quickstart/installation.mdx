...
<Tabs>
  ...
  <Tab title="macOS Intel">
    ```bash
    # Download the latest release
    curl -L https://github.com/cadcamfun/nikcli/releases/latest/download/nikcli-x86_64-apple-darwin -o nikcli
  ...
  <Tab title="Linux x64">
    ```bash
    # Download the latest release
    curl -L https://github.com/cadcamfun/nikcli/releases/latest/download/nikcli-x86_64-linux -o nikcli
...
<AccordionGroup>
  ...
  <Accordion title="API Key Not Detected">
    If NikCLI doesn't detect your API key:
    ...
    3. Use the configuration command:
    ```bash
    nikcli config set anthropic-api-key "your-key"
    ```
  </Accordion>
  ...
  <Accordion title="Binary Execution Issues">
    ...
    3. Verify PATH includes the binary location:
    ```bash
...
<Note>
  Having trouble? Check our [troubleshooting guide](/troubleshooting/common-issues) or [open an issue](https://github.com/cadcamfun/nikcli/issues) on GitHub.
</Note>