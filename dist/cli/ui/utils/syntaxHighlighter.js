...
exports.validateSyntax = exports.formatCode = exports.detectLanguage = exports.highlightCode = void 0;
const highlight_js_1 = __importDefault(require("highlight.js"));
const highlightCode = (code, language) => {
    try {
        // Use highlight.js for syntax highlighting
        const highlighted = highlight_js_1.default.highlight(code, { language, ignoreIllegals: true });
...
const parseHighlightedCode = (html) => {
