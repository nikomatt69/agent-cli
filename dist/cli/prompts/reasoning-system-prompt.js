...
exports.createReasoningSystemPrompt = createReasoningSystemPrompt;
exports.createUniversalAgentPrompt = createUniversalAgentPrompt;
exports.createSpecializedAgentPrompt = createSpecializedAgentPrompt;
exports.validateReasoningResponse = validateReasoningResponse;
function createReasoningSystemPrompt(context) {
...
function createUniversalAgentPrompt(context) {
...
function createSpecializedAgentPrompt(context, specialization) {
    const basePrompt = createReasoningSystemPrompt(context);
...
- Security testing`
    ...
    const specializationContent = specializations[specialization] || '';
...
function validateReasoningResponse(response) {
    const violations = [];
    const suggestions = [];
